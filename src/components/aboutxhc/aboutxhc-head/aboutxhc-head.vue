 ...
 * @LastEditTime: 2023-02-20 15:32:53
...
<template>
  <div>
    <section id="home">
      ...
      <div class="container">
        <div class="row">
          <div class="rol-md-12 rol-xs-12">
            <h1 class="cyjlaosong">我们相信科技是生命的第一创造力</h1>
            <div class="divider"></div>
            <h4>我们以前沿的生化科学及技术研究为企业生命力,</h4>
            <h4>探索并攻克严重疾病治愈的疗法，</h4>
            <h4>重新点燃患者生命之光。</h4>
          </div>
        </div>
        <div class="row">
